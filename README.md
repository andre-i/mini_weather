...
+ **Браузеры**. Так как отображение значений датчиков идёт в виде SVG графики, то для просмотра соответственно надо выбирать браузер с поддержкой SVG графики. Мозила, хром, опера нормально отображают страницы, остальные не проверял.
