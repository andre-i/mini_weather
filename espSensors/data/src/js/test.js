 ...
 */
 (function(){
	 //  form
	//  selectNames = ["sensorSelect", "intervalSelect", "yearSelect", "monthSelect", "daySelect"];
...
/*
 chart API:
  ...
  2) create(chart_name , Array_of_values)     string and numbers array
 ...
 */
	...
	function drawLast(sensor, data) {
		...
		chartBoard.create(chartName, PrepareArr(sensor.name));
